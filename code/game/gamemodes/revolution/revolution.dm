...
/datum/game_mode/revolution
	...
	antag_flag = ROLE_REV
	restricted_jobs = list("Security Officer", "Warden", "Detective", "AI", "Cyborg","Captain", "Lieutenant", /*"Head of Personnel",*/ "Head of Security", "Chief Engineer", "Research Director", "Chief Medical Officer", "Service Manager")
	required_players = 10
	required_enemies = 1
...
/datum/game_mode/revolution/announce()
	...
	world << "<B>Some crewmembers are attempting to start a revolution!<BR>\nRevolutionaries - Kill the Captain, Lieutenant, HoS, CE, RD, SM, and CMO. Convert other crewmembers (excluding the heads of staff, and security officers) to your cause by flashing them. Protect your leaders.<BR>\nPersonnel - Protect the heads of staff. Kill the leaders of the revolution, and brainwash the other revolutionaries (by beating them in the head).</B>"
